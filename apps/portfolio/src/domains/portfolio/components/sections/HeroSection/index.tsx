      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8 flex justify-center">
          <div className="relative">
            <div className="glass h-32 w-32 rounded-full p-1 backdrop-blur-xl md:h-40 md:w-40">
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <motion.a
            href="#contact"
            className="glass-hover inline-flex items-center justify-center rounded-full px-8 py-3 text-body-default-bold backdrop-blur-xl"
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.95 }}
          >
            {t('hero.cta.contact')}
