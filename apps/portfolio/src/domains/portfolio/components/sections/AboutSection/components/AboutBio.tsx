	...
	return (
		...
		>
			<motion.span
				...
				className="inline-block text-body-default-bold text-primary mb-2"
			>
				{t("about.subtitle")}
			</motion.span>
			<motion.h2
				variants={itemVariants}
				className="text-title-large-bold md:text-display-small-bold text-foreground mb-6"
			>
				{t("about.title")}
			</motion.h2>
			<motion.div
			...
			<motion.div variants={itemVariants} className="mt-8">
				<h3 className="text-title-small-bold text-foreground mb-3">
