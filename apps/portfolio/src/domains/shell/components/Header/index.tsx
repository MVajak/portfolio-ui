...
export function Header() {
	...
	return (
		<>
			...
			<header className="fixed top-0 left-0 right-0 md:left-20 md:right-20 z-50">
				<nav className="glass mx-4 mt-4 rounded-full px-4 py-2 md:mx-8">
					<div className="flex items-center justify-between">
						{/* Logo */}
						<motion.a
							href="#hero"
							className="text-title-small-bold text-foreground"
						...
						<motion.button
							type="button"
							className="flex h-10 w-10 items-center justify-center rounded-full glass-hover md:hidden"
